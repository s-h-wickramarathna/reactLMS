    ...
    <>
      <div className="col-12 bg-light">
        <div className="row">
          ...
          <div className="mt-5 rounded-3 col-12 overflow-auto">
            <div className="row gap-5 d-flex justify-content-center">
              <div className="col-12 overflow-x-auto">
                <div className="m-1">
                  <div className="p-2">
                    <p className="fw-bold fs-5 text-black-50">Current Exams</p>
                  </div>
          ...
          <div className="mt-5 rounded-3 col-12 overflow-auto">
            <div className="row gap-5 d-flex justify-content-center">
              <div className="col-12 overflow-x-auto">
                <div className="m-1">
                  <div className="p-2">
                    <p className="fw-bold fs-5 text-black-50">All Exams</p>
                  </div>
